...
const Hand = {
    ...
    getNOfAKind: (hand, n) => {
        ...
        const nOfAKind = Hand.getAllCardsOfRank(nRank, hand)
        return Hand.fill(nOfAKind, hand)
    },

    getFourOfAKind: (hand) => {
        return Hand.getNOfAKind(hand, 4)
    },
    ...
    getThreeOfAKind: (hand) => {
        return Hand.getNOfAKind(hand, 3)
    },
     ...
     */
    getPair: (hand) => {
        return Hand.getNOfAKind(hand, 2)
    },
